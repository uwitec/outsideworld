...
public class Phase03Test {
	...
	public void testExtract() throws Exception {
		Item item = new Item();
		// 1.天涯车友会
		item.setUrl("http://groups.tianya.cn/tribe/showArticle.jsp?groupId=42746&articleId=b9086dd13231a4f261294a9c54af5ed8");
		// 2.猫扑汽车频道
		item.setUrl("http://dzh.mop.com/tgzq/20120615/0/gF5lSlI29e8cc9F3.shtml");
		// 3.腾讯侃车天地版
		item.setUrl("http://club.auto.qq.com/thread-409238-1-1.html");
		// 4.水木房地产;404页面
		item.setUrl("http://www.newsmth.net/nForum/#!article/RealEstate/3366489");
		// 5.网易江苏
		item.setUrl("http://bbs.local.163.com/bbs/localjs/253963251.html");
		// 6.网易江苏
		item.setUrl("http://bbs.ynet.com/viewthread.php?tid=1415229&extra=page%3D1");
