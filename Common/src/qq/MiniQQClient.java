        ...
        {   
            ...
            {   
                ...
                {   
                    ...
                    User user = new User(obj.getString("uin"), obj.getString("nick"), obj.getInt("face"), obj.getLong("flag"));   
    ...
    {   
    	if(!isGroup)
    	{
	        ...
	        ////////////
		        ...
		        String thw=Think.getWords(content);
