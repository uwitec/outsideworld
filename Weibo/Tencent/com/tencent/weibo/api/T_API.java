...
public class T_API extends RequestAPI {
	...
	public String add_pic(OAuth oauth, String format, String content,
		...
		if (new File(picpath).exists()) {
			...
			return postFile("http://open.t.qq.com/api/t/add_pic", parameters,
					pic, oauth);
		} else {
			parameters.add(new QParameter("pic_url", picpath));
			return postContent("http://open.t.qq.com/api/t/add_pic_url",
					parameters, oauth);
		}
	 ...
	 */
	/*
	 * public String add_video_prev( OAuth oauth, String format, String content,
	 * String clientip, String jing, String wei,String vid ) throws Exception {
	 * List<QParameter> parameters = new ArrayList<QParameter>();
	 * parameters.add(new QParameter("format", format)); parameters.add(new
	 * QParameter("content", content)); parameters.add(new
	 * QParameter("clientip", clientip)); parameters.add(new QParameter("jing",
	 * jing)); parameters.add(new QParameter("wei", wei)); parameters.add(new
	 * QParameter("vid", vid));
	 * 
	 * return postContent("http://open.t.qq.com/api/t/add_video_prev",
	 * parameters, oauth); }
	 */
}
