...
insert into function(function_id,url,module,title) values('20','inventory/Storage_home','Inventory','进货单管理');
...
insert into role_privalige(role_id,function_id) values(0,20);
insert into role_privalige(role_id,function_id) values(1,1);
insert into role_privalige(role_id,function_id) values(1,1);
insert into role_privalige(role_id,function_id) values(2,20);
