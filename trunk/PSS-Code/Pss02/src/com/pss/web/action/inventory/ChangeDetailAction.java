 ...
 */
@Controller
public class ChangeDetailAction extends DetailsPaginationAction<StorageDetail> {

	private static final long serialVersionUID = 1L;

	@Autowired
	private IStorageDetailService changeDetailService;

	@Override
	public IBusinessService<StorageDetail> service() {
		return changeDetailService;
	}
}
