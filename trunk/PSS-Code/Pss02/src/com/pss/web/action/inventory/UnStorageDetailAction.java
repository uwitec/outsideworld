 ...
 */
@Controller
public class UnStorageDetailAction extends DetailsPaginationAction<StorageDetail> {

	private static final long serialVersionUID = 1L;

	@Autowired
	private IStorageDetailService unStorageDetailService;

	@Override
	public IBusinessService<StorageDetail> service() {
		return unStorageDetailService;
	}
}
