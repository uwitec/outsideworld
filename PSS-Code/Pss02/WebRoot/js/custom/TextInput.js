...
dojo.declare("custom.TextInput", [ dijit.form.ValidationTextBox,
		dijit._Templated ], {
	remote : "",
	...
	postCreate : function() {
		...
		if (this.remote != "") {
			dojo.connect(this.textbox, "onkeyup", this, "remoteValidate");
		}
	},
	remoteValidate : function(event) {
		// If value is valid
		if (this.validate()) {
			this.serverValidate(this.domNode.name, this.domNode.value);
		}
	},
